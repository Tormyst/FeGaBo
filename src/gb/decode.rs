...
fn decode_internal(op: u8, op2: u8, op3: u8) -> (OpCode, Op, u16, usize) {
    ...
    match op {
        ...
        0x27 => op!(op, DAA, 4),
        0x28 => op!(op, op2, JR(OF_Z, op2 as i8), 8),
        ...
        0x34 => op!(op, INC8(Mem(HL)), 12),
        0x35 => op!(op, DEC8(Mem(HL)), 12),
        0x36 => op!(op, op2, LD8(Mem(HL), imm8!(op2)), 12),
        0x37 => op!(op, SCF, 4),
        0x38 => op!(op, op2, JR(OF_C, op2 as i8), 8),
        ...
        0x70 => op!(op, LD8(Mem(HL), B), 8),
        0x71 => op!(op, LD8(Mem(HL), C), 8),
        0x72 => op!(op, LD8(Mem(HL), D), 8),
        0x73 => op!(op, LD8(Mem(HL), E), 8),
        0x74 => op!(op, LD8(Mem(HL), H), 8),
        0x75 => op!(op, LD8(Mem(HL), L), 8),
        0x76 => op!(op, HALT, 4),
        0x77 => op!(op, LD8(Mem(HL), A),8),
...
pub fn cb_table(op: u8) -> (OpCode, Op, u16, usize) {
    ...
    match op {
        ...
        0x46 => op!(0xCB, op, BIT(0, Mem(HL)), 12),
        ...
        0x4E => op!(0xCB, op, BIT(1, Mem(HL)), 12),
        ...
        0x56 => op!(0xCB, op, BIT(2, Mem(HL)), 12),
        ...
        0x5E => op!(0xCB, op, BIT(3, Mem(HL)), 12),
        ...
        0x66 => op!(0xCB, op, BIT(4, Mem(HL)), 12),
        ...
        0x6E => op!(0xCB, op, BIT(5, Mem(HL)), 12),
        ...
        0x76 => op!(0xCB, op, BIT(6, Mem(HL)), 12),
        ...
        0x7E => op!(0xCB, op, BIT(7, Mem(HL)), 12),
        ...
        _ => panic!("Instruction CB{:02X} cannot be decoded.", op),
    }
}
